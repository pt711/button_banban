...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : PE2_INPUT_Pin PE3_INPUT_Pin */
  GPIO_InitStruct.Pin = PE2_INPUT_Pin|PE3_INPUT_Pin;
  ...
  /*Configure GPIO pin : PF2_INPUT_Pin */
  GPIO_InitStruct.Pin = PF2_INPUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(PF2_INPUT_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : PA2_INPUT_Pin PA3_INPUT_Pin PA8_INPUT_Pin */
  GPIO_InitStruct.Pin = PA2_INPUT_Pin|PA3_INPUT_Pin|PA8_INPUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : PB0_INPUT_Pin PB11_INPUT_Pin PB15_INPUT_Pin PB5_INPUT_Pin
                           PB6_INPUT_Pin */
  GPIO_InitStruct.Pin = PB0_INPUT_Pin|PB11_INPUT_Pin|PB15_INPUT_Pin|PB5_INPUT_Pin
                          |PB6_INPUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  ...
  /*Configure GPIO pin : PD7_INPUT_Pin */
  GPIO_InitStruct.Pin = PD7_INPUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(PD7_INPUT_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : PG9_INPUT_Pin PG10_INPUT_Pin PG12_INPUT_Pin PG15_INPUT_Pin */
  GPIO_InitStruct.Pin = PG9_INPUT_Pin|PG10_INPUT_Pin|PG12_INPUT_Pin|PG15_INPUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
